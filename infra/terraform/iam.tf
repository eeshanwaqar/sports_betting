...
# S3 access for MLflow artifact storage
...
# ── GitHub Actions OIDC Provider (keyless AWS auth) ──────────
    ...
    Statement = [{
      ...
      Condition = {
        ...
        StringLike = {
          ...
          "token.actions.githubusercontent.com:sub" = "repo:eeshanwaqar/sports_betting:*"
        }
      }
    }]
  })
...
# GitHub Actions needs: ECR push, ECS deploy, S3 access
